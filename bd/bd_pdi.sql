...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2015 a las 21:04:08
...
INSERT INTO `detalle_funcionario` (`id_detalle_f`, `id_usuario`, `id_grado`, `id_cargo`, `id_categoria_usu`, `id_estado_usu`, `fecha_detalle_usuario`) VALUES
(1, 1, 3, 1, 2, 1, '2015-11-24'),
(2, 2, 2, 1, 1, 1, '2015-11-24'),
(3, 3, 1, NULL, 1, 1, '2015-11-24'),
(4, 4, 1, NULL, 1, 1, '2015-11-24'),
(5, 48, 2, 1, 10, 1, '2015-11-28'),
(6, 49, 8, 3, 5, 1, '2015-11-29'),
(7, 50, 5, 3, 4, 1, '2015-11-29'),
(8, 51, 5, 3, 5, 1, '2015-11-29'),
(9, 3, 8, 3, 7, 1, '2015-11-29');
...
(1, 'PREFECTURA PROVINCIAL DEL BIO BIO', 'PROBIO', 'PREFECTURA PROVINCIAL', 8301, NULL),
(2, 'BRIGADA DE INVESTIGACION CRIMINAL LOS ANGELES', 'BICRIM LAG', 'BRIGADA CRIMINAL', 8301, 1),
(3, 'BRIGADA DE INVESTIGACION CRIMINAL CABRERO', 'BICRIM CAB', 'BRIGADA CRIMINAL CABRERO', 8303, 1),
(4, 'BRIGADA ANTINARCOTICOS LOS ANGELES', 'BRIANT LAG', 'Brigada antinarcóticos', 8301, 1),
(5, 'BRIGADA INVESTIGADORA DE DELITOS SEXUALES Y MENORES LOS ANGELES', 'BRISEXME LAG', 'BRIGADA DE DELITOS SEXUALES Y MENORES', 8301, 1),
(6, 'BRIGADA DE HOMICIDIOS LOS ANGELES', 'BH LAG', 'BRIGADA DE HOMICIDIOS', 8301, 1),
(7, 'ASESORIA TECNICA LOS ANGELES', 'ASETEC LAG', 'ASESORÍA TECNICA', 8301, 1),
(8, 'GRUPO ESPECIALIZADO EN BIENES ROBADOS LOS ANGELES', 'GEBRO LAG', 'GRUPO ESPECIALIZADO EN BIENES ROBADOS', 8301, 1),
(9, 'DEPARTAMENTO DE EXTRANJERIA Y POLICIA INTERNACIONAL LOS ANGELES', 'POLINT LAG', 'DEPARTAMENTO DE EXTRANJERÍA Y POLICÍA INTERNACIONAL', 8301, 1),
(10, 'FUERZA TAREA PROBIO', 'FUERZA TAREA PROBIO', 'FUERZA TAREA', 8301, 1);
...
(13, 6, 5, '2015-11-28 15:42:59', 5),
(16, 1, 8, '2015-11-29 01:40:57', NULL),
(17, 1, 9, '2015-11-29 03:42:28', NULL);
...
INSERT INTO `usuarios` (`id_usuario`, `nombres_usu`, `apellidos_usu`, `rut`, `clave`, `fecha_ing`) VALUES
(1, 'VICTOR ', 'POLANCO', '11.111.111-1', 'MTIzMTIz', '2015-11-24'),
(2, 'ALBERTO', 'LOPEZ', '15.897.286-7', 'MTIzMTIz', '2015-11-25'),
(3, 'YONATAN EDUARDO', 'ESCOBAR', '15.943.298-K', 'MTIzMTIz', '2015-11-24'),
(4, 'JUAN', 'CABRERA', '1.718.706-6', 'MTIzMTIz', '2015-11-30'),
(48, 'VICTOR EMILIO', 'POLANCO CAMPOS', '17.745.408-7', 'MTIzMTIz', '2015-11-30'),
(49, 'Samuel', 'Guerra', '19.771.965-6', 'MTIzMTIz', '2015-11-29'),
(50, 'Roberto', 'Bonilla', '19.323.534-4', 'MTIzMTIz', '2015-11-01'),
(51, 'Fernando', 'Aragon', '22.222.222-2', 'MTIzMTIz', '2015-11-22');
...
--
-- AUTO_INCREMENT de la tabla `unidad_jefe`
--
ALTER TABLE `unidad_jefe`
  MODIFY `id_unidad_jefe` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
