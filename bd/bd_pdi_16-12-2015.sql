...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `casos` (
  `id_casos` int(5) NOT NULL AUTO_INCREMENT,
  `nombre_casos` varchar(50) NOT NULL,
  `id_categoria_det` int(5) DEFAULT NULL,
  PRIMARY KEY (`id_casos`),
  KEY `id_categoria_det` (`id_categoria_det`),
  CONSTRAINT `casos_ibfk_1` FOREIGN KEY (`id_categoria_det`) REFERENCES `categoria_det` (`id_categoria_det`)
...
INSERT INTO `casos` VALUES (13,'ORDENES DE INVESTIGAR',35),(14,'ORDENES DE DETENCION',35),(15,'ORDENES POR GIRDOC',35),(16,'ORDENES DE ARRESTO',35),(17,'TRAM. Y/O INSTRUCCIONES',35),(18,'CITACIONES',35),(19,'ORDENES VERBALES',35),(20,'DETENIDOS AL JUZGADOS',35),(21,'SERVICIOS DE GUARDIA',35),(22,'COMISIONES DE SERVICIO',35),(23,'CONTROLES DE IDENTIDAD',35);
...
CREATE TABLE `categoria_det` (
  `id_categoria_det` int(5) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `categoria_det` VALUES (1,4,'APERTURA DE LA HOJA DE VIDA ANUAL'),(2,4,'LABOR QUE CUMPLE EN LA UNIDAD'),(3,4,'TOMA CONOCIMIENTO DE'),(4,4,'COMISIÓN DE SERVICIO CON DERECHO'),(5,4,'COMISIÓN DE SERVICIO SIN DERECHO'),(6,4,'PERMISO ADMINISTRATIVO CON GOCE DE REMUNERACIÓN'),(7,4,'PERMISO ADMINISTRATIVO SIN GOCE DE REMUNERACIÓN'),(8,3,'LICENCIA MEDICA'),(9,3,'FINALIZA LICENCIA MÉDICA'),(10,3,'FERIADO LEGAL'),(11,3,'FINALIZA FERIADO LEGAL'),(12,4,'FINALIZA COMISIÓN DE SERVICIO'),(13,4,'LISTA DE CLASIFICACIÓN ANUAL'),(14,4,'DESTINACIÓN'),(15,4,'DESPACHO DE LA UNIDAD'),(16,4,'PRESENTACIÓN EN LA UNIDAD'),(17,1,'ASCENSO'),(18,1,'CONSTANCIA POSITIVA'),(19,2,'CONSTANCIA NEGATIVA'),(20,1,'ANOTACIÓN DE MERITO'),(21,2,'ANOTACIÓN DE DEMERITO'),(22,1,'FELICITACIÓN'),(23,2,'SANCIÓN'),(24,4,'SOBRESEIMIENTO'),(25,4,'CONSTANCIA DE DICTAMEN'),(26,4,'CONSTANCIA DE RESOLUCIÓN'),(27,4,'CONSTANCIA DE APELACIÓN'),(28,4,'CONSTANCIA DE RECLAMO'),(29,4,'EVALUACIÓN MENSUAL'),(30,4,'MEDICINA PREVENTIVA'),(31,4,'DESIGNACIÓN COMO FISCAL'),(32,4,'DESIGNACIÓN COMO OFICIAL INVESTIGADOR'),(33,4,'EVALUACIÓN DE DESMPEÑO COMO FISCAL'),(34,4,'EVALUACIÓN DE DESMPEÑO COMO OFICIAL INVESTIGADOR'),(35,4,'RESUMEN ESTADÍSTICO DE LABOR MENSUAL'),(36,4,'OPINIÓN DE JEFE'),(37,4,'CAMBIO DE JEFE CALIFICADOR'),(38,4,'UBICACIÓN DE ESCALAFONES'),(39,4,'CUENTA ESCRITA'),(40,4,'RESOLUCIÓN CUENTA ESCRITA'),(41,4,'CIERRE DE HOJA DE VIDA ANUAL'),(42,4,'RESUMEN');
...
INSERT INTO `detalle_funcionario` VALUES (1,1,3,1,2,1,'2015-11-24'),(2,2,2,1,1,1,'2015-11-24'),(3,3,1,3,1,2,'2015-11-24'),(4,4,1,3,1,1,'2015-11-24'),(5,48,2,1,10,1,'2015-11-28'),(6,49,8,3,5,1,'2015-11-29'),(7,50,5,3,4,1,'2015-11-29'),(8,51,5,3,5,2,'2015-11-29'),(9,3,8,3,7,2,'2015-11-29'),(10,52,7,3,7,1,'2015-11-30'),(11,51,4,2,5,1,'2015-12-05'),(12,3,8,3,6,1,'2015-12-10'),(13,53,9,3,12,2,'2015-12-11'),(14,53,9,3,11,1,'2015-12-11');
...
CREATE TABLE `detalle_hoja_vida` (
  `id_detalle_hv` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `detalle_titulo` longtext,
  PRIMARY KEY (`id_detalle_hv`),
  KEY `id_tipo_casos` (`cantidad`),
  ...
  CONSTRAINT `detalle_hoja_vida_ibfk_6` FOREIGN KEY (`id_subcategoria_det`) REFERENCES `subcategoria_det` (`id_subcategoria_det`)
...
INSERT INTO `detalle_hoja_vida` VALUES (2,NULL,NULL,1,1,1,'2015-12-08 00:00:00','Apertura de la hoja de vida anual'),(3,NULL,NULL,1,20,1,'2015-12-06 00:00:00','Apertura de la Hoja de vida Anual'),(4,NULL,NULL,1,20,31,'2015-12-07 00:00:00','DESIGNACIÓN COMO FISCAL'),(5,NULL,NULL,1,20,3,'2015-12-06 00:00:00','ESPERO QUE RESULTE'),(8,NULL,1,1,22,35,'0000-00-00 00:00:00','ESTA ES LA EVALUACIÓN MENSUAL DEL FUNCIONARIO NNNN'),(9,NULL,1,1,22,35,'2015-12-14 00:00:00','ESTA ES LA EVALUACIÓN MENSUAL DEL FUNCIONARIO NNNN'),(10,NULL,NULL,1,1,7,'2015-12-15 00:00:00','hola mundo asdasdsaddsaasdsad'),(11,NULL,1,1,20,35,'2015-12-15 00:00:00','Esta es la evaluación mensual');
/*!40000 ALTER TABLE `detalle_hoja_vida` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `detalle_resumen`
--

DROP TABLE IF EXISTS `detalle_resumen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `detalle_resumen` (
  `id_detalle_resumen` int(11) NOT NULL AUTO_INCREMENT,
  `id_tipo_casos` int(11) NOT NULL,
  `id_detalle_hv` int(11) NOT NULL,
  PRIMARY KEY (`id_detalle_resumen`),
  KEY `id_detalle_hv` (`id_detalle_hv`),
  KEY `id_tipo_casos` (`id_tipo_casos`),
  CONSTRAINT `detalle_resumen_ibfk_4` FOREIGN KEY (`id_detalle_hv`) REFERENCES `detalle_hoja_vida` (`id_detalle_hv`),
  CONSTRAINT `detalle_resumen_ibfk_5` FOREIGN KEY (`id_tipo_casos`) REFERENCES `tipo_casos` (`id_tipo_casos`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `detalle_resumen`
--

LOCK TABLES `detalle_resumen` WRITE;
/*!40000 ALTER TABLE `detalle_resumen` DISABLE KEYS */;
INSERT INTO `detalle_resumen` VALUES (3,3,8),(4,4,8),(5,5,8),(6,6,8),(7,7,8),(8,8,8),(9,9,8),(10,10,8),(11,11,8),(12,12,8),(13,13,8),(14,14,9),(15,15,9),(16,16,9),(17,17,9),(18,18,9),(19,19,9),(20,20,9),(21,21,9),(22,22,9),(23,23,9),(24,24,9),(25,25,11),(26,26,11),(27,27,11),(28,28,11),(29,29,11),(30,30,11),(31,31,11),(32,32,11),(33,33,11),(34,34,11),(35,35,11);
/*!40000 ALTER TABLE `detalle_resumen` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `hoja_vida` (
  `id_hoja_vida` int(5) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(5) NOT NULL,
  `id_detalle_hv` int(11) NOT NULL,
  PRIMARY KEY (`id_hoja_vida`),
  KEY `id_detalle_f` (`id_usuario`),
  KEY `id_detalle_hv` (`id_detalle_hv`),
  CONSTRAINT `hoja_vida_ibfk_2` FOREIGN KEY (`id_detalle_hv`) REFERENCES `detalle_hoja_vida` (`id_detalle_hv`),
  CONSTRAINT `hoja_vida_ibfk_3` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
...
INSERT INTO `hoja_vida` VALUES (1,1,2),(2,3,3),(3,3,4),(4,3,5),(7,53,8),(8,53,9),(9,1,10),(10,3,11);
...
CREATE TABLE `subcategoria_det` (
  `id_subcategoria_det` int(5) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `subcategoria_det` VALUES (1,35,'EVALUACIÓN'),(2,42,'TOTAL FELICITACIONES'),(3,42,'TOTAL ANOTACIONES DE MERITO'),(4,42,'TOTAL ANOTACIONES DE DEMETIRO'),(5,42,'TOTAL CONSTANCIAS POSITIVAS'),(6,42,'TOTAL CONSTANCIAS NEGATIVAS'),(7,42,'TOTAL SANCIONES'),(8,42,'SUMARIOS ADMINISTRATIVOS'),(9,42,'LICENCIAS MEDICAS');
...
CREATE TABLE `tipo_casos` (
  `id_tipo_casos` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tipo_casos` VALUES (3,13,2,2,4),(4,14,2,2,5),(5,15,2,2,5),(6,16,2,2,4),(7,17,1,1,5),(8,18,1,1,3),(9,19,NULL,NULL,6),(10,20,NULL,NULL,3),(11,21,NULL,NULL,5),(12,22,NULL,NULL,1),(13,23,NULL,NULL,0),(14,13,2,2,4),(15,14,2,2,5),(16,15,2,2,5),(17,16,2,2,4),(18,17,1,1,5),(19,18,1,1,3),(20,19,NULL,NULL,6),(21,20,NULL,NULL,3),(22,21,NULL,NULL,5),(23,22,NULL,NULL,1),(24,23,NULL,NULL,0),(25,13,3,9,7),(26,14,5,2,8),(27,15,3,2,5),(28,16,1,1,3),(29,17,0,0,1),(30,18,1,1,2),(31,19,NULL,NULL,1),(32,20,NULL,NULL,1),(33,21,NULL,NULL,1),(34,22,NULL,NULL,1),(35,23,NULL,NULL,1);
...
CREATE TABLE `tipo_cat` (
  `id_tipo_cat` int(5) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tipo_cat` VALUES (1,'POSITIVA'),(2,'NEGATIVA'),(3,'ADVERTENCIA'),(4,'NORMAL');
...
CREATE TABLE `unidad` (
  ...
  `nombre_unidad` varchar(80) CHARACTER SET latin1 NOT NULL,
  `sigla` varchar(20) CHARACTER SET latin1 NOT NULL,
  `desc_unidad` varchar(120) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `unidad_jefe` VALUES (1,1,1,'2015-11-24 16:39:52',NULL),(2,1,3,'2015-11-25 16:40:03',1),(3,2,2,'2015-11-24 16:40:23',NULL),(4,2,4,'2015-11-27 16:40:43',2),(13,6,5,'2015-11-28 15:42:59',5),(16,1,8,'2015-11-29 01:40:57',NULL),(17,1,9,'2015-11-29 03:42:28',1),(18,1,10,'2015-11-30 18:58:40',1),(19,1,11,'2015-12-05 18:45:00',1),(20,1,12,'2015-12-10 11:56:31',NULL),(21,1,13,'2015-12-11 18:16:13',NULL),(22,1,14,'2015-12-11 18:17:00',NULL);
...
INSERT INTO `usuarios` VALUES (1,'VICTOR ','POLANCO','11.111.111-1','MTIzMTIz','2015-11-24'),(2,'ALBERTO','LOPEZ','15.897.286-7','MTIzMTIz','2015-11-25'),(3,'YONATAN','ESCOBAR OVIEDO','15.943.298-K','MTIzMTIz','2015-11-24'),(4,'JUAN','CABRERA','1.718.706-6','MTIzMTIz','2015-11-30'),(48,'VICTOR EMILIO','POLANCO CAMPOS','17.745.408-7','MTIzMTIz','2015-11-30'),(49,'Samuel','Guerra','19.771.965-6','MTIzMTIz','2015-11-29'),(50,'Roberto','Bonilla','19.323.534-4','MTIzMTIz','2015-11-01'),(51,'Fernando','Aragon','22.222.222-2','MTIzMTIz','2015-11-22'),(52,'Juan Ignacio','Lopez Rodriguez','33.333.333-3','MTIzMTIz','2015-11-01'),(53,'Juan','Perez','55.555.555-5','MTIzMTIz','2015-12-06');
...
-- Dump completed on 2015-12-16  2:31:43
